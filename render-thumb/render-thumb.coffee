...
main = ->
  ...
  spec = fs.readFileSync (sprintf '/storage/projekti/js.icfp16vis/all-problems/%05d.txt', id),
    encoding: 'utf-8'
  draw_canvas ctx, spec, true
  fs.writeFileSync (sprintf './t%05d.png', id), ca.toBuffer()
